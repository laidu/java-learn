...
//        result = RSAencryptionUtil.getInstance().encrypt(palaintext.getBytes(),rsaPublicKey);
    ...
    void getPublicKey() throws Exception {
        ...
        X509EncodedKeySpec keySpec = new X509EncodedKeySpec(jodd.util.Base64.decode("MIGfMA0GCSqGSIb3DQEBAQUAA4GNADCBiQKBgQCKNwbSS18PD+lq/kthgNhRv4kmErhqC9X+VLPsbAFRojB+Hiohx7uuD+xcoxfB6BvcKKvPd2/WLDhVlOxsKFlWlzVZG7rCaP38e77jdgDmAVJtmZmyaW/q09fxR8dtwVqiwPtpNUeBWWh1lrtUarY8cQ8KFg5tNYqvqQJ9bN3TAwIDAQAB"));
